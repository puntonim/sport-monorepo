...
__all__ = ["BaseStravaTokenManager", "BaseStravaTokenManagerException"]


class BaseStravaTokenManager:
    ...
    def _refresh_token_from_strava(self):
        ...
        if not self._token.get("access_token"):
            raise BaseStravaTokenManagerException(
...
class BaseStravaTokenManagerException(Exception):
    pass
