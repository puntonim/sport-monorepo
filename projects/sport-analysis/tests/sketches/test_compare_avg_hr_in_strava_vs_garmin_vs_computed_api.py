...
from sport_analysis.sketches.compare_avg_hr_in_strava_vs_garmin_vs_computed_api import (
    compare_avg_hr_in_strava_vs_garmin_vs_computed_api,
)
...
class TestCompareAvgHrInStravaVsGarminVsComputedApi:
