...
@click.command(
    ...
    \b
    Examples
    $ san plot-21km-run 18948270166 -vs 18891426764 -vs 12877651519 --title "Sarnico-Lovere" --figure-size 5.0 6.5 --pace-plot-set-y-axis-bottom-to-slowest-pace-perc 4.5 -d ~/workspace/sport-monorepo/projects/sport-analysis/output-images/
    """,
)
@click.argument(
