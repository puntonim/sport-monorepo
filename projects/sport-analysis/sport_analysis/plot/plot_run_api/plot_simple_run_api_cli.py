...
@click.command(
    ...
    \b
     ...
     So to suppress any interactive questions:
       $ san plot-simple LATEST --no-questions
    \b
    Most popular, no questions:
      $ san plot-simple LATEST --percentile-to-draw P80 -hatch Z3 --no-questions
      $ san plot-simple 23309590263 -vs 19074660632 -vs 23226614861
    To interactively provide input for all options:
      $ san plot-simple
    All possible args, no questions:
      $ san plot-simple-run 23309590263 -vs 19074660632 -vs 23226614861 -hatch Z0 -hatch Z1 --percentile-to-draw P98 --pace-plot-set-y-axis-bottom-to-slowest-pace-perc 3.5 --title
'Fosso BG' --figure-size 5.0 6.5 --dir '/tmp/output-images'
    """,
)
@click.argument(
