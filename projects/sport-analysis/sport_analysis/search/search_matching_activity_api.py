...
@click.command(
    ...
    help="Search for the matching Garmin activity given a Strava activity id; eg. san search-matching-garmin-activity 14211292173",
)
...
@click.command(
    ...
    help="Search for the matching Strava activity given a Garmin activity id; eg. san search-matching-strava-activity 18606916834",
)
